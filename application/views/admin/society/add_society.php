...
<div class="container row">
    <h3><?php echo $this->lang->line('add') . ' ' . $this->lang->line('menu_society'); ?></h3>
    <hr>
</div>

<div class="container row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <form action="<?php echo ADMIN_BASE_URL . 'society/save' ?>" method="post" id="add_society" class="form-horizontal">
