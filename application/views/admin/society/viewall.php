<script type="text/javascript" >
    $(document).ready(function() {
        $('#list_setup_box').dataTable( {
            ...
            "sAjaxSource": "<?php echo ADMIN_BASE_URL . "society/getJson"; ?>"
        } );
    } );
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="row">
        <h3><?php echo $this->lang->line('maintain') . ' ' . $this->lang->line('menu_society'); ?></h3>
        <hr>
    </div>
    <div class="row add_button">
        <a href="<?php echo ADMIN_BASE_URL . 'society/add'; ?>" class="btn btn-default">
            <?php echo $this->lang->line('add') . ' ' . $this->lang->line('menu_society'); ?>
        </a>
    </div>
    <div class="row">
        <div class="col-md-12">
